...
void bopIt() { static const byte buttons[] = {34, 32, 35};
...
void sliceIt() { static const int irPin = 27;
...
if (irValue == LOW) { Serial.println("Object detected!"); } else { Serial.println("No object detected."); }

delay(200); }

void loop() { bopIt(); sliceIt(); }
